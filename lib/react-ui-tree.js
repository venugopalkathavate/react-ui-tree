...
class UITree extends Component {
  ...
  getClientOffset(e) {
    ...
    if (e.touches) {      
      offset.clientX = e.touches[0].pageX;
      offset.clientY = e.touches[0].pageY;      
    } else {
      offset.clientX = e.clientX;
      offset.clientY = e.clientY;
    }
  ...
  dragStart = (id, dom, e) => {
    const offset = this.getClientOffset(e);
    ...
    this._offsetX = offset.clientX;
    this._offsetY = offset.clientY;
    this._start = true;
  ...
  drag = e => {
    ...
    const pos = {
      x: _startX + offset.clientX - _offsetX,
      y: _startY + offset.clientY - _offsetY
    };
    dragging.x = pos.x;
    dragging.y = pos.y;
